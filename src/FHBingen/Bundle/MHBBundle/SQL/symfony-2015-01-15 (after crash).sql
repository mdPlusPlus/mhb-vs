...
--
-- Host: localhost
-- Erstellungszeit: 15. Jan 2015 um 16:38
...
(24, 2, 28, 3, 139, 'Pflichtfach', 'B-BI-PÜ03', 'Betriebswirtschaftslehre', NULL),
...
(78, 2, 30, 3, 148, 'Wahlpflichtfach', 'B-BI-WI10', NULL, NULL),
...
(9, 3, 42, 4, 163, 'Pflichtfach', 'B-MC-MN02', NULL, NULL),
(12, 3, 42, 4, 164, 'Pflichtfach', 'B-MC-MN03', NULL, NULL),
...
(37, 3, 52, 4, 186, 'Pflichtfach', 'B-MC-MC09', 'Mensch-Maschine-Interaktion', NULL),
...
(53, 3, 44, 4, 208, 'Wahlpflichtfach', 'B-MC-WP20', NULL, NULL),
...
(101, 4, 48, 5, 220, 'Wahlpflichtfach', 'M-IS-WP03', NULL, NULL),
(102, 4, 48, 5, 221, 'Wahlpflichtfach', 'M-IS-WP04', NULL, NULL),
(100, 4, 48, 5, 222, 'Wahlpflichtfach', 'M-IS-WP02', NULL, NULL),
...
(120, 2, 23, 3, 235, 'Pflichtfach', 'B-BI-MN01', NULL, NULL),
...
(58, 2, 26, 3, 245, 'Pflichtfach', 'B-BI-MN06', NULL, NULL),
(117, 4, 49, 5, 246, 'Wahlpflichtfach', 'M-IS-WP21', NULL, NULL),
(119, 3, 52, 4, 247, 'Pflichtfach', 'B-MC-MC08', NULL, NULL),
(138, NULL, 24, 2, 257, 'Wahlpflichtfach', 'DUMMY', NULL, NULL);
...
(2, 34, 'Herr', 'Prof. Dr.', 'Hans', 'Rollo', 'rollo@test.com', '$2y$12$0mknyiyoN/keWDG72CwN5uX4VKyZzaNxJSXwE4KEWurYdXfCyCnQ.', 1),
(1, 42, 'Herr', 'Prof. Dr.', 'Test', 'Testuser1', 'test1@test.com', '$2y$12$lIh4paXvDd9xCFuorBxSSevgNUQrSPMbVS.aqGdaxTKQwVPGJTl/6', 1),
(2, 43, 'Herr', 'Prof. Dr.', 'Test', 'Testuser2', 'test2@test.com', '$2y$12$k57TAj9KKXSF86sHY6E4vuW/mgFAChhvNUaUaNbUVaOOUmMCDXuES', 1),
(1, 44, 'Herr', NULL, 'Dummy', 'N.N.', 'test@test.com', '$2y$12$YPhz2PnWdrDNnWPDDYbweewgIrN7/epvgkx6Q8yhK9WTXRis2sB62', 1),
(1, 45, 'Herr', NULL, 'Dummy', 'Alle Dozenten möglich', 'lolo@test.com', '$2y$12$bJNEnJygUKltjgOUouBxSe1e9YHIe4BPeI1tA8Ib9wz4//50mNRiy', 1);
...
(34, 10, 2, 'Bachelor', 'Test-Studiengang', 'TEST', 'Test');
...
CREATE TABLE IF NOT EXISTS `VeranstaltungHistory` (
  ...
  `PruefungsformSonstiges` longtext COLLATE utf8_unicode_ci NOT NULL,
  `Sprache` longtext COLLATE utf8_unicode_ci NOT NULL,
  `SpracheSonstiges` longtext COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `VeranstaltungHistory` (`Modul_ID`, `Erstellungsdatum`, `Versionsnummer`, `Kuerzel`, `Name`, `NameEN`, `Haeufigkeit`, `Dauer`, `Lehrveranstaltungen`, `KontaktzeitVL`, `KontaktzeitSonstige`, `Selbststudium`, `Gruppengroesse`, `Lernergebnisse`, `Inhalte`, `Pruefungsformen`, `PruefungsformSonstiges`, `Sprache`, `SpracheSonstiges`, `Autor`, `Literatur`, `Leistungspunkte`, `VoraussetzungLP`, `VoraussetzungInhalte`) VALUES
(138, '2015-01-11', 1, 'TEST', 'Freigabetest Modul', 'Englischer Titel', 'Sommersemester', '1', 'TeST', 50, 30, 10, 20, 'Test', 'Test', 'DASD', 'erew', 'Deutsch', 'erwe', 'Prof. Dr. Schmidt', 'Test', 3, 'SDASD', 'HISTORY'),
(138, '2015-01-11', 2, 'TEST', 'Freigabetest Modul', 'Englischer Titel', 'Sommersemester', '1', 'TeST', 50, 30, 10, 20, 'Test', 'Test', 'DASD', 'erew', 'Deutsch', 'erwe', 'Prof. Dr. Schmidt', 'Test', 3, 'SDASD', 'HISTORY ZWEEEEI'),
(138, '2015-01-11', 3, 'TEST', 'Freigabetest Modul', 'Englischer Titel', 'Sommersemester', '1', '["Seminar"]', 50, 30, 10, 20, 'Test', 'Test', '["M\\u00fcndliche Pr\\u00fcfung"]', 'erew', 'Deutsch', 'erwe', 'Prof. Dr. Schmidt', 'Test', 3, '["Pr\\u00fcfungsleistung"]', 'HISTORY ZWEEEEI');
